...
blob_fixups: blob_fixups_user_type = {
    ...
    (
        'vendor/etc/media_codecs_kera_v0.xml',
        'vendor/etc/media_codecs_kera_v1.xml',
        'vendor/etc/media_codecs_sun.xml',
        'vendor/etc/media_codecs_tuna_v0.xml',
        'vendor/etc/media_codecs_tuna_v1.xml',
    ): blob_fixup()        .regex_replace('.*media_codecs_(google_audio|google_c2|google_telephony|google_video|vendor_audio).*\n', ''),
